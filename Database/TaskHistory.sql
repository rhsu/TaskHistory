-- MySQL dump 10.13  Distrib 5.7.17, for Linux (x86_64)UTO_INCREMENT=18
--
...
--
/*!50003 DROP PROCEDURE IF EXISTS `DefaultUser_Exists` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `DefaultUser_Exists`()
BEGIN
	SELECT COUNT(1)
    FROM
		`Users`
...
-- Dump completed on 2017-03-12 14:54:54
